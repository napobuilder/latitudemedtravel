        ...
        <div className={`fixed inset-0 z-50 ${isOpen ? '' : 'invisible'}`}>
            ...
            <div className={`absolute right-0 top-0 h-full w-full max-w-md bg-white shadow-xl transform transition-transform duration-300 flex flex-col ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                <div className="flex items-center justify-between p-6 border-b">
                    <h2 className="text-2xl font-bold text-brand-blue-900">Valoración</h2>
                ...
                {!item ? (
                    <div className="flex-grow p-6 flex flex-col items-center justify-center text-center">
                        ...
                        <h3 className="text-xl font-semibold text-gray-700">No hay valoración seleccionada</h3>
                        <p className="text-gray-500 mt-2">Selecciona un procedimiento para agendar tu valoración.</p>
                    </div>
                ) : (
                    <div className="flex-grow overflow-y-auto p-6">
                        <div className="bg-gray-50 rounded-xl p-6 mb-4">
                            ...
                            <div className="border-t pt-4 mt-4">
                                <p className="text-sm text-gray-600 mb-2">Esta valoración incluye:</p>
                ...
                <div className="p-6 border-t bg-gray-50">
                    <div className="flex justify-between items-center mb-4 text-lg">
                          <span className="font-medium text-gray-600">Total de la Valoración</span>
