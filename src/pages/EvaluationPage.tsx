          ...
          {isSuccess ? (
             <div className="bg-white rounded-3xl shadow-2xl p-10 text-center border border-gray-100 transform transition-all animate-fade-in-up relative overflow-hidden">
               ...
               <p className="text-gray-600 mb-4 font-inter text-lg max-w-lg mx-auto leading-relaxed">
                 {isSpanish 
                   ? `¡Gracias, ${formData.firstName || 'futuro paciente'}! Hemos recibido tu expediente médico de forma segura.` 
                   : `Thank you, ${formData.firstName || 'future patient'}! We have securely received your medical dossier.`}
               </p>
               <p className="text-sm text-gray-500 mb-8 max-w-md mx-auto leading-relaxed">
                 {isSpanish 
                   ? "Nuestro equipo médico y coordinador(a) están revisando tu perfil. Nos comunicaremos contigo a la brevedad posible vía WhatsApp o correo electrónico para continuar con tu evaluación completa."
                   : "Our medical board and concierge team are reviewing your profile. We will contact you as soon as possible via WhatsApp or email to proceed with your full evaluation."}
               </p>
